  ...
  return (
    <BubblePrimitive
      ...
      className={cn(
        ...
        '[&_[data-slot=bubble-avatar]]:mt-0.5 [&_[data-slot=bubble-avatar]]:flex [&_[data-slot=bubble-avatar]]:size-8 [&_[data-slot=bubble-avatar]]:shrink-0 [&_[data-slot=bubble-avatar]]:items-center [&_[data-slot=bubble-avatar]]:justify-center [&_[data-slot=bubble-avatar]]:overflow-hidden [&_[data-slot=bubble-avatar]]:rounded-full [&_[data-slot=bubble-avatar]]:bg-[var(--llm-color-muted)] [&_[data-slot=bubble-avatar]]:text-xs [&_[data-slot=bubble-avatar]]:font-medium [&_[data-slot=bubble-avatar]]:text-[var(--llm-color-muted-foreground)]',
        ...
        role === 'system' &&
          'justify-center [&_[data-slot=bubble-avatar]]:hidden [&_[data-slot=bubble-body]]:max-w-full [&_[data-slot=bubble-body]]:items-center [&_[data-slot=bubble-content]]:px-0 [&_[data-slot=bubble-content]]:py-0 [&_[data-slot=bubble-content]]:text-xs [&_[data-slot=bubble-content]]:text-[var(--llm-color-muted-foreground)] [&_[data-slot=bubble-meta]]:justify-center',
        className,
      )}
      {...props}
    />
